...
export default function Footer() {
  ...
  return (
    <footer className="text-white/70" style={{ background: "hsl(340 15% 20%)" }}>
      <div className="mx-auto max-w-7xl px-4 py-14 sm:px-6 lg:px-8">
        <div className="grid gap-10 sm:grid-cols-2 lg:grid-cols-4">
          <div className="sm:col-span-2 lg:col-span-1">
            ...
            <a href="https://www.instagram.com/virginie_assistance_numerique" target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-2 text-sm font-light text-white/50 transition-colors hover:text-white/80">
          ...
          <div>
            <h4 className="mb-4 font-serif text-sm font-medium text-white">Contact</h4>
            <div className="space-y-4 text-sm font-light text-white/50">
              ...
              <div className="flex items-start gap-3">
                ...
                <span>La Rochelle & alentours<br />Rayon de 20 km</span>
              </div>
            </div>
          </div>
        </div>
